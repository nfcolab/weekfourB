...
m=8
big_ui = ui(1920, 1280)
big_ui.add_element("a1", 10*m,30*m,30*m,20*m, color ="red")
...
big_ui.add_element("c1", 150*m,30*m,30*m,20*m, color ="blue")
...
big_ui.add_element("t4", 250*m,0*m,30*m,20*m, color ="yellow")
